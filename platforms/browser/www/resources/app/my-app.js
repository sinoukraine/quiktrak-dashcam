						...
						function downloadMediaFile(){
							...
							if (networkState == Connection.NONE) {
								...
								function fileSystemSuccess(fileSystem) {
									...
									var lp = 'file:///storage/emulated/0/Download/' + fileName;//// //'file:///storage/emulated/0/Download/' + fileName;'file:///data/user/0/com.quiktrak.quiktrak_dashcam/files/files/' + folder + '/' + fileName;
